  ...
  var Wizard = (function (_Plugin) {
    ...
    function Wizard(opts) {
      ...
      var _this = possibleConstructorReturn(
        this,
        (Wizard.__proto__ || Object.getPrototypeOf(Wizard)).call(this, opts)
      );
    ...
    createClass(Wizard, [
      {
        ...
        value: function install() {
          ...
          this.steps = [].concat(
            toConsumableArray(form.querySelectorAll(this.opts.stepSelector))
          );
          ...
          classSet(
            this.steps[0],
            defineProperty({}, this.opts.activeStepClass, true)
          );
        ...
        value: function onClickPrev() {
          if (this.currentStep >= 1) {
            classSet(
              ...
              defineProperty({}, this.opts.activeStepClass, false)
            );
            this.currentStep--;
            classSet(
              this.steps[this.currentStep],
          ...
          this.core.validate().then(function (status) {
            if (status === Status$1.Valid) {
              ...
              if (nextStep >= _this3.numSteps) {
                ...
                classSet(
                  _this3.steps[_this3.currentStep],
                  defineProperty({}, _this3.opts.activeStepClass, false)
                );
                _this3.currentStep = nextStep;
                classSet(
                  _this3.steps[_this3.currentStep],
                  defineProperty({}, _this3.opts.activeStepClass, true)
                );
              }
              _this3.onStepActive();
              _this3.onStepValid();
