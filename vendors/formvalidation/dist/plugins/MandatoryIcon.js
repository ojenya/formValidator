  ...
  var MandatoryIcon = (function (_Plugin) {
    ...
    function MandatoryIcon(opts) {
      ...
      var _this = possibleConstructorReturn(
        this,
        (MandatoryIcon.__proto__ || Object.getPrototypeOf(MandatoryIcon)).call(
          this,
          opts
        )
      );
      ...
      _this.removedIcons =
        ((_this$removedIcons = {}),
        defineProperty(_this$removedIcons, Status$1.Valid, ""),
        defineProperty(_this$removedIcons, Status$1.Invalid, ""),
        defineProperty(_this$removedIcons, Status$1.Validating, ""),
        defineProperty(_this$removedIcons, Status$1.NotValidated, ""),
        _this$removedIcons);
      _this.icons = new Map();
    ...
    createClass(MandatoryIcon, [
      ...
      },
      {
        ...
        value: function onIconPlaced(e) {
          ...
          if (
            ...
            try {
              for (
                var _iterator = elementArray[Symbol.iterator](), _step;
                ...
                if (this.core.getElementValue(e.field, ele) === "") {
                  classSet(
                    e.iconElement,
                    defineProperty({}, this.opts.icon, true)
                  );
                }
              }
            } catch (err) {
          ...
          var feedbackIcons =
            ...
            defineProperty(
              _feedbackIcons,
              Status$1.Valid,
              this.iconClasses.valid ? this.iconClasses.valid.split(" ") : []
            ),
            defineProperty(
              _feedbackIcons,
              Status$1.Invalid,
          ...
          Object.keys(feedbackIcons).forEach(function (status) {
            ...
            try {
              for (
                var _iterator2 = icons[Symbol.iterator](), _step2;
      ...
      },
      {
        ...
        value: function onElementValidated(e) {
          this.updateIconClasses(
            e.element,
            e.valid ? Status$1.Valid : Status$1.Invalid
          );
        },
      },
      {
        ...
        value: function updateIconClasses(ele, status) {
          ...
          if (
            ...
            classSet(
              icon,
              ((_classSet2 = {}),
              defineProperty(_classSet2, this.removedIcons[status], false),
              defineProperty(_classSet2, this.opts.icon, false),
              _classSet2)
            );
          }
        },
      },
      {
        ...
        value: function onIconSet(e) {
          ...
          if (
            icon &&
            e.status === Status$1.NotValidated &&
